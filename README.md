...
Entre na pasta `backend` e digite no terminal:
```bash
python manage.py runserver
```

Depois abra outro terminal, entre na pasta `atividades-escolares` e no terminal rode:
```bash
npm run dev
```
...
| tiagoprof@email.com    | 123456 |Professor|
| prof@email.com         | 123456 |Professor|
| fernando@email.com     | 123456 |Aluno|
| aluno@email.com        | 123456 |Aluno|
| clara@email.com        | 123456 |Aluno|
| tatiana@email.com      | 123456 |Aluno|
